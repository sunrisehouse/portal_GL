...
BindedVertexInfo* PortalZVerticesBinder::bind()
{
	...
	vertices.push_back({ cube_vertices[0], vec3(0.0f, 0.0f, 1.0f), vec2(1.0f, 1.0f) });
	vertices.push_back({ cube_vertices[1], vec3(0.0f, 0.0f, 1.0f), vec2(0.0f, 1.0f) });
	vertices.push_back({ cube_vertices[2], vec3(0.0f, 0.0f, 1.0f), vec2(0.0f, 0.0f) });
	vertices.push_back({ cube_vertices[3], vec3(0.0f, 0.0f, 1.0f), vec2(1.0f, 0.0f) });
	...
	vertices.push_back({ cube_vertices[4], vec3(0.0f, 0.0f, -1.0f), vec2(1.0f, 1.0f) });
	vertices.push_back({ cube_vertices[7], vec3(0.0f, 0.0f, -1.0f), vec2(0.0f, 1.0f) });
	vertices.push_back({ cube_vertices[6], vec3(0.0f, 0.0f, -1.0f), vec2(0.0f, 0.0f) });
	vertices.push_back({ cube_vertices[5], vec3(0.0f, 0.0f, -1.0f), vec2(1.0f, 0.0f) });
