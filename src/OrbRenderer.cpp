...
OrbRenderer::OrbRenderer(BindedVertexInfo* vertex_info, BindedTextureInfo* texture_info, SolarSystemRotationalObject* object, Material* material, GLint mode)
	:vertex_info(vertex_info), texture_info(texture_info), object(object), mode(mode), material(material)
{
}

mat4 OrbRenderer::get_model_matrix()
{
...
void OrbRenderer::render(GLuint program)
{
